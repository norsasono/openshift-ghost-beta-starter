...
define('ghost-admin/tests/acceptance/authentication-test', ['jquery', 'ghost-admin/authenticators/oauth2', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/utils/ghost-paths', 'ember-runloop', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/utils/window-proxy', 'ember-cli-mirage', 'mocha', 'ghost-admin/tests/helpers/ember-simple-auth', 'chai'], function (_jquery, _oauth, _destroyApp, _ghostPaths, _emberRunloop, _startApp, _windowProxy, _emberCliMirage, _mocha, _emberSimpleAuth, _chai) {
    ...
    (0, _mocha.describe)('Acceptance: Authentication', function () {
        ...
        (0, _mocha.describe)('token handling', function () {
            ...
            (0, _mocha.it)('refreshes app tokens on boot', _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
                var requests, refreshRequest, requestBody;
        ...
        (0, _mocha.describe)('general page', function () {
            ...
            (0, _mocha.it)('invalidates session on 401 API response', _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
            ...
            (0, _mocha.it)('doesn\'t show navigation menu on invalid url when not authenticated', _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
            ...
            (0, _mocha.it)('shows nav menu on invalid url when authenticated', _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
        ...
        _mocha.describe.skip('editor', function () {
            ...
            (0, _mocha.it)('displays re-auth modal attempting to save with invalid session', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
                var role;
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                ...
                                server.put('/posts/:id/', function (_ref7, _ref8) {
        ...
        (0, _mocha.it)('adds auth headers to jquery ajax', function () {
            var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(done) {
                var role;
...
define('ghost-admin/tests/acceptance/settings/tags-test', ['jquery', 'ghost-admin/tests/helpers/destroy-app', 'ember-runloop', 'ghost-admin/tests/helpers/start-app', 'ember-cli-mirage', 'mocha', 'ghost-admin/tests/helpers/ember-simple-auth', 'ghost-admin/tests/helpers/adapter-error', 'chai'], function (_jquery, _destroyApp, _emberRunloop, _startApp, _emberCliMirage, _mocha, _emberSimpleAuth, _adapterError, _chai) {
    ...
    (0, _mocha.describe)('Acceptance: Settings - Tags', function () {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('has infinite scroll pagination of tags list', _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
                return regeneratorRuntime.wrap(function _callee5$(_context5) {
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.next = 3;
                                return visit('settings/tags/tag-0');
                            ...
                            case 3:
                                ...
                                _context5.next = 6;
                                return find('.tag-list').scrollTop(find('.tag-list-content').height());

                            case 6:
                                _context5.next = 8;
                                return triggerEvent('.tag-list', 'scroll');
            ...
            (0, _mocha.it)('shows the internal tag label', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
                return regeneratorRuntime.wrap(function _callee6$(_context6) {
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
            ...
            (0, _mocha.it)('redirects to 404 when tag does not exist', _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
                return regeneratorRuntime.wrap(function _callee7$(_context7) {
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            case 0:
...
define('ghost-admin/tests/app.lint-test', [], function () {
  ...
  describe('ESLint | app', function () {
    ...
    it('authenticators/oauth2-ghost-388d6367bd4a124b01dd32811cb242bc.js', function () {
      // test passed
    });
...
define('ghost-admin/tests/integration/components/gh-profile-image-test', ['pretender', 'ember-service', 'ember-runloop', 'ember-test-helpers/wait', 'mocha', 'chai', 'ember-mocha'], function (_pretender, _emberService, _emberRunloop, _wait, _mocha, _chai, _emberMocha) {
    'use strict';
...
//# sourceMappingURL=tests-2b15fb27a3d9c21afa507632b7e1267c.map
